	<section>
		<div class="mod-wrapper photo-gallery">
			...
			<div class="mod-inner row"> 
				<section>
					<ul class="photos" >
						 <li class="panel1"><img src="challenges/gameAssets/galleries/13-ufo/1_lg.jpg"></li>
						 <li class="panel2"><img src="challenges/gameAssets/galleries/13-ufo/2_lg.jpg"></li>
					</ul>
				</section>
				...
				<nav id="photoThumbs" class="row">
					<ul class="navlinks photo_thumbs">
						<li class="active" ><a href="#1">
															<img src="challenges/gameAssets/galleries/13-ufo/1_lg.jpg" width=161></a></li>
						 <li><a href="#2"><img src="challenges/gameAssets/galleries/13-ufo/2_lg.jpg" width=161></a></li>
					</ul>
				</nav>
			</div>
		</div>
