			...
			<nav id="site_nav" class="es-carousel-wrapper">
				<div class="es-carousel">
					<ul id="mainNav" class="navlinks">
						<li><a href="featured"><img src="<?= BASE_URL; ?>assets/images/thumb_nightswim.jpg" alt="image01"></a>Featured: Night Swim</li>
                                                <li><a href="streetart"><img src="<?= BASE_URL; ?>assets/images/thumb_featured2.png" alt="image02"></a>Street Art</li>
						<li><a href="anthem"><img src="<?= BASE_URL; ?>assets/images/thumb_anthem.jpg" alt="image03"></a>Stunt Anthem</li> 
						<li><a href="okgo"><img src="<?= BASE_URL; ?>assets/images/thumb_okGo.jpg" alt="image04"></a>OK Go Music Video</li>
						<li><a href="kickflip"><img src="<?= BASE_URL; ?>assets/images/thumb_dyrdek.jpg" alt="image05"></a>Kickflip</li>
						<li><a href="skydive"><img src="<?= BASE_URL; ?>assets/images/thumb_skydive.jpg" alt="image06"></a>Skydive</li>
						<li><a href="bungee"><img src="<?= BASE_URL; ?>assets/images/thumb_bungee.jpg" alt="image07"></a>Bungee</li>
						<li><a href="claw"><img src="<?= BASE_URL; ?>assets/images/thumb_claw.jpg" alt="image08"></a>Claw</li>
