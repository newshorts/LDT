...
<head>
	...
	<script type="text/javascript" src="assets/javascripts/social_btns.js"></script>
<!-- Facebook Open Graph tags -->
	<meta property="og:title" content="Let's Do This" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="http://letsdothis.com" />
	<meta property="og:image" content="http://50.57.203.161/assets/images/fb.jpg" />
	...
	<!--[if lte IE 8]>
	<link rel="stylesheet" href="../assets/stylesheets/anythingslider-ie.css" type="text/css" media="screen" />
	<![endif]-->
	...
	<script src="../assets/javascripts/plugins.min.js"></script>
	<!-- Syndicated Nav JS -->
...
<div class="container">
	...
	<div id="mod-wrapper-top">	
		<header class="row">
			<div id="headerSlider">
				<img src="../assets/images/masthead6.jpg" alt="Header Street Art">
				<img src="../assets/images/masthead1.jpg" alt="Header Dyrdek Kickflip">
				<img src="../assets/images/masthead2.jpg" alt="Header OK Go">
				<img src="../assets/images/masthead3.jpg" alt="Header Bungee">
				<img src="../assets/images/masthead4.jpg" alt="Header Skydive">
				<img src="../assets/images/masthead5.jpg" alt="Header Claw">
			</div>
			...
			<nav id="site_nav" class="es-carousel-wrapper">
				<div class="es-carousel">
					<ul id="mainNav" class="navlinks">
						<li><a href="featured"><img src="assets/images/thumb_featured2.png" alt="image01"></a>Featured: Street Art</li> 
						<li><a href="okgo"><img src="assets/images/thumb_okGo.jpg" alt="image02"></a>OK Go Music Video</li>
						<li><a href="kickflip"><img src="assets/images/thumb_dyrdek.jpg" alt="image03"></a>Kickflip</li>
						<li><a href="skydive"><img src="assets/images/thumb_skydive.jpg" alt="image04"></a>Skydive</li>
						<li><a href="bungee"><img src="assets/images/thumb_bungee.jpg" alt="image05"></a>Bungee</li>
						<li><a href="claw"><img src="assets/images/thumb_claw.jpg" alt="image06"></a>Claw</li>
						<li class="kerningTight"><a href="#" target="_self"><img src="assets/images/thumb_firsts.jpg" alt="image06"></a>Best of the Game of Firsts</li>
					</ul>
				</div>
			</nav>
		</div>
