...
var s_account="gmchevysonicletsdothis"
...
s.linkTrackEvents="event1,event2,event3,event4,event5,event6,event7,event8,event9,event10,event11,event12,event13,event14"

s.usePlugins=true
function s_doPlugins(s) {
	/* Add calls to plugins here */
	//s.prop4 = thumbClick();
	/* Captures the campaign ID from the query string and only sets it once per visit*/
    if(!s.campaign) {
        s.campaign=s.getQueryParam('cmp','seo');
	...
	if(!s.eVar2) {
	    s.eVar2=s.getQueryParam('s');
	}
}
s.doPlugins=s_doPlugins
s.loadModule("Integrate")
var socialInterval = setInterval( function() { s.facebookSocialPlugins('eVar50','fb:like>event26','fb:unlike>event27','fb:comment>event28','fb:remove comment>event29','fb:login>event30','fb:logout>event31','fb:send>event32'); }, 1000);
/************************** PLUGINS SECTION *************************/
/* You may insert any plugins you wish to use here.                 */
//clickButtons for tracking added 3-11-12

(function($){

	//Main Navigation
	$('#site_nav li a').click(function(){
		var getPage = $(this).parents('body').attr('name');
		var theThumb= $(this).attr("id");
		//var theThumb = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
			...
			s.prop4='CAROUSEL'; 
			s.prop5=getPage + ' | CAROUSEL'; 
			s.prop6='FIRSTS | ' + getPage + ' | CAROUSEL';
			s.tl(true,'o', theThumb +' Click');
	});
	//Videos
	$('#vidCarousel li a').click(function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
			s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6']; 
			s.prop1='FIRSTS';
			...
			s.prop3='FIRSTS | ' + getPage;
			s.prop4='VIDEOS'; 
			s.prop5=getPage + ' | VIDEOS'; 
			s.prop6='FIRSTS | ' + getPage + ' | VIDEOS'; 
			s.tl(true,'o','Thumbnail Click');
	...
	$('#photo_thumbs a').click(function(){
		...
		var s=s_gi('gmchevysonicletsdothis'); 
			...
			s.prop3='FIRSTS | ' + getPage;
			s.prop4='PHOTOS'; 
			s.prop5=getPage + ' | PHOTOS'; 
			s.prop6='FIRSTS | ' + getPage + ' | PHOTOS'; 
			s.tl(true,'o','Thumbnail Click');
		});
	//Map
	$('#map_thumbs a').click(function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
			s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6']; 
			s.prop1='FIRSTS';
			...
			s.prop3='FIRSTS | ' + getPage;
			s.prop4='TRACK'; 
			s.prop5=getPage + ' | TRACK'; 
			s.prop6='FIRSTS | ' + getPage + ' | TRACK'; 
			s.tl(true,'o','Thumbnail Click');
	});
	//More about Sonic
	$('#sonic_link a').click(function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
			s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10']; 
			s.prop1='FIRSTS';
			s.prop2=getPage;
			s.prop3='FIRSTS | ' + getPage;
			s.prop4='MASTHEAD'; 
			s.prop5=getPage + ' | MASTHEAD'; 
			s.prop6='FIRSTS | ' + getPage + ' | MASTHEAD'; 
			s.prop7='SONIC HOME';
			s.prop8='MASTHEAD | SONIC HOME';
			s.prop9=getPage + '| MASTHEAD | SONIC HOME';
			s.prop10='FIRSTS |' + getPage + '| MASTHEAD | SONIC HOME';
			s.tl(true,'o','More About Sonic Click');
	});
	//Songs
	$('#songDownload li a').click(function(){
	var getPage = $(this).parents('body').attr('name');
	var songName = $(this).parent
	var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6']; 
		s.prop1='FIRSTS';
		s.prop2=getPage;
		s.prop3='FIRSTS | ' + getPage;
		s.prop4='DOWNLOAD'; 
		s.prop5=getPage + ' | DOWNLOAD'; 
		s.prop6='FIRSTS | ' + getPage + ' | DOWNLOAD';
		s.tl(true,'o','Downloaded The Song');
	});

	$('.downloads li a').click(function(){
	...
	var s=s_gi('gmchevysonicletsdothis'); 
		...
		s.prop5=getPage + ' | DOWNLOAD'; 
		s.prop6='FIRSTS | ' + getPage + ' | DOWNLOAD';
		s.tl(true,'o','Downloaded');				
	});

	//Social Main
	$('#social1 ul li.twitter').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		...
		s.prop7='TWITTER';
		s.prop8='SHARING | TWITTER';
		s.prop9= getPage +' | SHARING | TWITTER';
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | TWITTER';
		s.prop11='CAROUSEL';
		s.prop12='TWITTER | CAROUSEL';
		s.prop13='SHARING | TWITTER | CAROUSEL';
		s.prop14= getPage +' | SHARING | TWITTER | CAROUSEL';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | TWITTER | CAROUSEL'; 
		s.tl(true,'o','Twitter MainNav Click'); 
	});
	$('#social1 ul li.facebook a').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10', 'prop11', 'prop12', 'prop13', 'prop14', 'prop15']; 
		s.prop1='FIRSTS';
		...
		s.prop5= getPage +' | SHARING'; 
		s.prop6='FIRSTS | ' + getPage + ' | SHARING';
		s.prop7='FACEBOOK LIKE';
		s.prop8='SHARING | FACEBOOK LIKE';
		s.prop9= getPage +' | SHARING | FACEBOOK LIKE';
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE';
		s.prop11='CAROUSEL';
		s.prop12='FACEBOOK LIKE | CAROUSEL';
		s.prop13='SHARING | FACEBOOK LIKE | CAROUSEL';
		s.prop14= getPage +' | SHARING | FACEBOOK LIKE | CAROUSEL';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE | CAROUSEL';
		s.tl(true,'o','Facebook MainNav Click'); 
	});
	//Social Videos 
	$('#social2 .twitter a').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10', 'prop11', 'prop12', 'prop13', 'prop14', 'prop15']; 
		s.prop1='FIRSTS';
		...
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | TWITTER';
		s.prop11='VIDEO';
		s.prop12='TWITTER | VIDEO';
		s.prop13='SHARING | TWITTER | VIDEO';
		s.prop14= getPage +' | SHARING | TWITTER | VIDEO';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | TWITTER | VIDEO';  
		s.tl(true,'o','Twitter Video Click'); 
	}); 
	$('#social2 .facebook a').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10', 'prop11', 'prop12', 'prop13', 'prop14', 'prop15']; 
		s.prop1='FIRSTS';
		...
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE';
		s.prop11='VIDEO';
		s.prop12='FACEBOOK LIKE | VIDEO';
		s.prop13='SHARING | FACEBOOK LIKE | VIDEO';
		s.prop14= getPage +' | SHARING | FACEBOOK LIKE | VIDEO';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE | VIDEO'; 
		s.tl(true,'o','Facebook Video Click'); 
	});
	//Social Photos 
	$('#social3 .twitter a').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10', 'prop11', 'prop12', 'prop13', 'prop14', 'prop15']; 
		s.prop1='FIRSTS';
		...
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | TWITTER';
		s.prop11='PHOTOS';
		s.prop12='TWITTER | PHOTOS';
		s.prop13='SHARING | TWITTER | PHOTOS';
		s.prop14= getPage +' | SHARING | TWITTER | PHOTOS';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | TWITTER | PHOTOS';
		s.tl(true,'o','Twitter Photo Click'); 
	}); 
	$('#social3 .facebook a').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10', 'prop11', 'prop12', 'prop13', 'prop14', 'prop15']; 
		s.prop1='FIRSTS';
		...
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE';
		s.prop11='PHOTOS';
		s.prop12='FACEBOOK LIKE | PHOTOS';
		s.prop13='SHARING | FACEBOOK LIKE | PHOTOS';
		s.prop14=getPage +' | SHARING | FACEBOOK LIKE | PHOTOS';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE | PHOTOS';
		s.tl(true,'o','Facebook Photo Click'); 
	});
	//Social 4
	$('#social4 .twitter a').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10', 'prop11', 'prop12', 'prop13', 'prop14', 'prop15']; 
		s.prop1='FIRSTS';
		...
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | TWITTER';
		s.prop11='TRACK';
		s.prop12='TWITTER | TRACK';
		s.prop13='SHARING | TWITTER | TRACK';
		s.prop14= getPage +' | SHARING | TWITTER | TRACK';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | TWITTER | TRACK';
		s.tl(true,'o','Twitter Photo Click'); 
	}); 
	$('#social4 .facebook a').click( function(){
		var getPage = $(this).parents('body').attr('name');
		var s=s_gi('gmchevysonicletsdothis'); 
		s.linkTrackVars=['prop1','prop2','prop3','prop4', 'prop5', 'prop6', 'prop7','prop8','prop9','prop10', 'prop11', 'prop12', 'prop13', 'prop14', 'prop15']; 
		s.prop1='FIRSTS';
		...
		s.prop10='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE';
		s.prop11='TRACK';
		s.prop12='FACEBOOK LIKE | TRACK';
		s.prop13='SHARING | FACEBOOK LIKE | TRACK';
		s.prop14=getPage +' | SHARING | FACEBOOK LIKE | TRACK';
		s.prop15='FIRSTS | ' + getPage + ' | SHARING | FACEBOOK LIKE | TRACK';
		s.tl(true,'o','Facebook Photo Click'); 
	});
}(jQuery));
...
s.trackingServer="generalmotors.112.2o7.net"
...
+"';else if(k=='javaEnabled')q='v';else if(k=='cookiesEnabled')q='k';else if(k=='browserWidth')q='bw';else if(k=='browserHeight')q='bh';else if(k=='connectionType')q='ct';else if(k== getPage+'page')q='hp'"
